  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        <h3 className="text-subheadline text-white mb-4">Confirm Purchase</h3>
  ...
  return (
    <>
      <div className="lg:bg-surface lg:rounded-xl lg:p-6">
        <h2 className="text-headline text-white mb-6 lg:text-xl lg:mb-4">Buy Airtime</h2>
        <form className="space-y-6 lg:space-y-4" onSubmit={handleSubmit}>
          <div>
            <label className="block text-body text-secondary mb-2 lg:text-sm lg:mb-1">Phone Number</label>
            <input
              type="tel"
              value={phoneNumber}
          ...
          <div>
            <label className="block text-body text-secondary mb-2 lg:text-sm lg:mb-1">Network</label>
            <select
              value={network}
          ...
          <div className="flex gap-3 flex-wrap lg:gap-2">
            {commonAmounts.map((amt) => (
              <button
                ...
                className="px-4 py-2 bg-accent/20 text-accent rounded-input text-body font-medium hover:bg-accent/30 lg:px-3 lg:py-1 lg:text-sm"
              >
                ₦{amt}
              </button>
            ))}
